                      ...
                      <div class="card-body">
                        ...
                        @if(session()->has('message'))
                              ...
                              @if($employeeData!=='')
                                ...
                                <form class="form-horizontal" action="{{ url('user_create/'.$id )}}" method="post">

                                  {{ csrf_field() }}

                                @foreach($employeeData as $empployeeRow)
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-4">
                                    <input type="text" class="form-control" name="firstname" value="{{ $empployeeRow->name }}" id="" placeholder="First Name">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-4">
                                    <input type="email" class="form-control" name="email" value="{{ $empployeeRow->office_mail_id }}" id="" placeholder="Email Id">
                                    @if($errors->has('email'))
